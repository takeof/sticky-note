...
const css = {
  code: ".input-form.svelte-5bvl4m{margin-left:20px}.input-item.svelte-5bvl4m{margin-bottom:20px}",
  map: null
};
const InputForm = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <div class="${"input-form svelte-5bvl4m"}"><div class="${"input-item svelte-5bvl4m"}">${validate_component(Textfield, "Textfield").$$render(
            $$result,
    ...
    <div class="${"input-item svelte-5bvl4m"}">${validate_component(Textfield, "Textfield").$$render(
            $$result,
            { label: "Limit", value: date },
            {
              value: ($$value) => {
                date = $$value;
                $$settled = false;
